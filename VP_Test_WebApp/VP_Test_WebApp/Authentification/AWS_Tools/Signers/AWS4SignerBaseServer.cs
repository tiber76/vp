...
using VP_Test_WebApp.Authentification.AWS_Tools.Util;
...
namespace VP_Test_WebApp.Authentification.AWS_Tools.Signers
{
    ...
    /// </summary>
    public abstract class AWS4SignerBaseServer
    {
        ...
        /// </returns>
        protected string CanonicalizeHeaderNames(IHeaderDictionary headers)
        {
        ...
        protected virtual string CanonicalizeHeaders(IHeaderDictionary headers, string CanonicalizeHeadersNames)
        {
            if (headers == null || headers.Count == 0 || string.IsNullOrWhiteSpace(CanonicalizeHeadersNames))
                return string.Empty;

            var CanonicalizeHeadersNamesTab = CanonicalizeHeadersNames.Split(';').ToList();
            ...
            {
                if (CanonicalizeHeadersNamesTab.Contains(header.ToLower()))
